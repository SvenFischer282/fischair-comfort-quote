      ...
      <section className="py-12 sm:py-16 md:py-20 bg-muted">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-base sm:text-lg md:text-xl text-center text-muted-foreground mb-10 sm:mb-16">
              Profesionálne riešenia pre komfortné a energeticky úsporné bývanie
            </p>

            <div className="prose prose-base sm:prose-lg max-w-none mb-10 sm:mb-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
              ...
              <Card>
                <CardContent className="p-6 sm:p-8 text-center">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-foreground">Tím expertov</h3>
                  <p className="text-sm sm:text-base text-muted-foreground">
              ...
              <Card>
                <CardContent className="p-6 sm:p-8 text-center">
                  ...
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-foreground">Prístup</h3>
                  <p className="text-sm sm:text-base text-muted-foreground">
